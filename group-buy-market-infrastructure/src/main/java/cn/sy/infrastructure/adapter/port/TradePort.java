package cn.sy.infrastructure.adapter.port;

import cn.sy.domain.trade.adapter.port.ITradePort;
import cn.sy.domain.trade.model.entity.NotifyTaskEntity;
import cn.sy.domain.trade.model.valobj.NotifyTypeEnumVO;
import cn.sy.infrastructure.event.EventPublisher;
import cn.sy.infrastructure.gateway.GroupBuyNotifyService;
import cn.sy.infrastructure.redis.IRedisService;
import cn.sy.types.enums.NotifyTaskHTTPEnumVO;
